(function (e, t, r) {
  ...
  var D = function (e, t) {
    var r = t.split("."),
      ...
      n = 0,
      a = e.length;
    var o = window.SRUtil.getPropertyArray(i, r),
      l;
    if (o[s]) {
      for (; n < a; n++) {
        l = o[s].apply(o, e[n])
  ...
  var F = function (e, t) {
    if (!y) {
      var r = e.split("."),
        n = r.pop(),
        a = window.SRUtil.getPropertyArray(i, r),
        l = a[n];
      return function () {
  ...
  var M = function () {
    var t = JSON.parse('0') || {};
    var r = window.SRUtil.extend(true, {
      debugLevel: h,
      client: {
    ...
    if (u) {
      ...
      window.SRUtil.each(u, function (e, t) {
        i.w.addFromWidgetloader(t, e)
      })
    }
    window.SRUtil.each(j, function () {
