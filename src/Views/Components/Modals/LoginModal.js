    ...
    return (
        <div className="login-popup-wrapper" id="popupLogin">
            <div className="login-popup">
                <div className="close-coupon-popup" onClick={() => dispatch({type: SHOW_LOGIN_MODAL})}>
                ...
                <div className="login-content">
                    ...
                    <div className="alert-bar">
                        <i className="fa fa-exclamation-triangle" aria-hidden="true" />Please login to continue
                    </div>
                    <form onSubmit={submitForm}>
                        ...
                        <div className="row">
                            <div className="forgot-text">
                                Forgot Password?
                                <NavLink to="/Auth/RecoverPassword" onClick={() => dispatch({type: SHOW_LOGIN_MODAL})}> Click here</NavLink> to create a new one.
                            </div>
                        </div>
                        <div className="button-holder">
                            <NavLink to="/Auth/Register" onClick={() => dispatch({type: SHOW_LOGIN_MODAL})}>
