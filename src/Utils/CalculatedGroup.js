const CalculatedGroup = (function () {
    ...
    CalculatedGroup.prototype.NetStakeMinWin = function () {
        return this.MinWinForUnit * this.StakeForCombinationTaxed;
    };
    ...
    CalculatedGroup.prototype.NetStakeMaxWin = function () {
        return this.MaxWinForUnit * this.StakeForCombinationTaxed;
    };
    CalculatedGroup.prototype.MinBonus = function () {
        return this.MinBonusForUnit * this.StakeForCombinationTaxed;
    };
    CalculatedGroup.prototype.MaxBonus = function () {
        return this.MaxBonusForUnit * this.StakeForCombinationTaxed;
    };
